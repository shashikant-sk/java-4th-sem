...
//-----------Starting with the displayPanel1() method to create the Login panel
		...
		{		 	
			  ...
			  {			   		
					...
					query1 = "SELECT * FROM login WHERE logname='"+val1+"' AND password='"+val2+"'";
		...
		void showResults(ResultSet r) throws SQLException 
		{
				...
				{		
						...
						if (param1.equals("shashikant") && param2.equals("password")) 
						{
	...
	class ButtonHandler implements ActionListener 
	    ...
	    //System.out.println("hello");
					selname = cb_sname.getSelectedItem().toString();
  					accessModifiedDatabase(Integer.parseInt(selname.substring(0,1)));					
    			}
