...
public class gui_data_base_program extends Frame implements ActionListener
{
	...
	{
		gui_data_base_program d=new gui_data_base_program();
		try
		{
			Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
			con=DriverManager.getConnection("jdbc:odbc:pp");
			sa=con.createStatement();
			rs=sa.executeQuery("select * from empolyeeee");
			rs.next();
			}
			catch(Exception e)
			{
