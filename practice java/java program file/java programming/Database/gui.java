...
public class gui extends Frame implements ActionListener
{
	...
	public gui()
	{
		...
		l1=new Label("empolyeeNo");
		l2=new Label("employeeSname");
		t1=new TextField(10);
		t2=new TextField(10);
		b1=new Button("Exit");
		b2=new Button("next");
	...
	public static void main(String args[])
	{
		...
		try
		{
			...
			rs=sa.executeQuery("select * from employeeee");
			rs.next();
			}
			catch(Exception e)
			{
			...
			catch(Exception e)
			{
				...
				else if(e2.getSource()==b3)
				{
					try
					{
						sa.executeUpdate("insert into employeeee values('"+t1.getText()+"','"+t2.getText()+"')");
